      ...
      <div className="workspace-card">
        {!loggedIn ? (
          <form onSubmit={handleSubmit} className="form-panel">
            <div className="credentials"><strong>Demo credentials</strong><span>Username: student</span><span>Password: student123</span></div>
          ...
          <div className="success-panel"><div className="success-icon">✓</div>
          <span className="status success">AUTHENTICATED</span>
          <h2>Welcome, {username}!</h2>
          <p>{message} You now have access to the React Activity Portal.</p>
